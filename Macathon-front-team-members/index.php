          ...
          <div class="col-lg-6">
            <form id="form" class="card" method="post" action="../loadMacathonForm.php" enctype="multipart/form-data">
              ...
              <div class="form-row">
                <div class="form-group col-md-6">
                  <i class="fa-solid fa-user icon"></i>
                  <input type="text" name="teamCode" class="form-control" placeholder="Your team code" required>
                </div>

                <input type="text" name="role" class="form-control" value="0" style="visibility:hidden;">
